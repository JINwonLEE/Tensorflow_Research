...
import os
print("TF_CPP_MIN_VLOG_LEVEL:",os.environ["TF_CPP_MIN_VLOG_LEVEL"])

def _load_fn(unused_op):
    return 1

# cluster specification
parameter_servers = ["10.20.13.128:2419", "10.20.13.129:2419"] #ferrari5, ferrari6
#parameter_servers = ["10.20.13.128:2319"] #ferrari5, ferrari6
workers = ["10.20.13.126:2419", "10.20.13.127:2419"] #ferrari3, ferrari4
...
training_epochs = 5
logs_path = "/tmp/mnist/roundrobin/"
...
if FLAGS.job_name == "ps":
  server.join()
    ...
    with tf.device(tf.train.replica_device_setter(
        ...
        #cluster=cluster)):
        cluster=cluster, ps_strategy=device_setter_lib.GreedyLoadBalancingStrategy(2, device_setter_lib.byte_size_load_fn))):
